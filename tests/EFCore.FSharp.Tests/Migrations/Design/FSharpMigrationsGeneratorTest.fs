        ...
        testList
            ...
            [
              ...
              test "Migrations compile" {
                  ...
                  modelBuilder.HasAnnotation(RelationalAnnotationNames.DbFunctions, Dictionary<string, IDbFunction>())
                  |> ignore
